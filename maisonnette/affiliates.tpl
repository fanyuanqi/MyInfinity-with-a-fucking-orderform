			...
			<div class="col-md-8">
				<div class="tabs">
					<ul role="tablist" class="nav nav-tabs nav-affiliate">
						<li class="nav-item">
							<a href="#tab-referrals" data-toggle="tab" role="tab" class="nav-link active">推荐</a>
						</li>
						{if $affiliatelinkscode}
						<li class="nav-item">
							<a href="#tab-links" data-toggle="tab" class="nav-link">广告图</a>
						</li>
						{/if}
					</ul>
				</div>
				<div class="tab-content">
					<div class="tab-pane active" role="tabpanel" id="tab-referrals">
						...
						<div class="well mb-4" style="position: relative;">
							...
							<span class="copy-message text-success hidden">已成功复制</span>
						</div>
