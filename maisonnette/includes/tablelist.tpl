<link rel="stylesheet" type="text/css" href="{$WEB_ROOT}/templates/{$template}/assets/css/dataTables.bootstrap.min.css?v=3">
<script type="text/javascript" charset="utf8" src="{$BASE_PATH_JS}/jquery.dataTables.min.js"></script>
<script type="text/javascript" charset="utf8" src="{$WEB_ROOT}/templates/{$template}/assets/js/dataTables.bootstrap.min.js?v=1"></script>
