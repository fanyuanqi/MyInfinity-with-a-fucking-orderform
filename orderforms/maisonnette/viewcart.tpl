...
<script>
	...
	$(function () {
		...
		$('.btn-login').click(function() {
		    ...
		    var post = $.post("cart.php?a=checkout",{ loginemail: 'loginemail', loginpassword: 'loginpassword' });
			post.done(
		        function(data) {
		...
		$('.fake-acceptos').siblings('.iCheck-helper').click(function(){
...
<div id="order-standard_cart" class="sidebar-right space">
	<div class="container" style="position: relative;">
        ...
        <div class="content-body">
		    ...
		    <input type="hidden" name="custtype" id="inputCustType" value="{$custtype}" />
				...
				<div class="tab-content tab-sm">
						    ...
						    <div class="col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
						      <div class="form-group">
						        <div class="input-icon input-icon-left input-icon-xlg">
						          ...
						          <input type="text" class="form-control input-xlg" name="loginemail" id="inputLoginEmail" placeholder="{$LANG.orderForm.emailAddress}">
						        </div>
						      </div>
						      <div class="form-group">
						        <div class="input-icon input-icon-left input-icon-xlg">
						          <div class="input-icon-addon">
			                        ...
			                        <input type="password" name="loginpassword" id="inputLoginPassword" class="form-control input-xlg" placeholder="{$LANG.clientareapassword}">
						        </div>
						      </div>
						      <button class="btn btn-block btn-lg btn-primary btn-login" style="position: relative;">
							      	<span>{$LANG.loginbutton}</span>
			        ...
			        <div id="tab-register" class="tab-pane active">
			            ...
			            <div class="tab-section">
				            <h5 class="tab-title">{$LANG.orderForm.billingAddress}</h5>
				            <div class="row">
		                    ...
		                    <div class="row">
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                                ...
		                                <input type="text" name="companyname" id="inputCompanyName" class="form-control" placeholder="{$LANG.orderForm.companyName} ({$LANG.orderForm.optional})" value="{$clientsdetails.companyname}"{if $loggedin} readonly="readonly"{/if}>
		                            </div>
		                        </div>
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                                ...
		                                <input type="text" name="address1" id="inputAddress1" class="form-control" placeholder="{$LANG.orderForm.streetAddress}" value="{$clientsdetails.address1}"{if $loggedin} readonly="readonly"{/if}>
		                            </div>
		                        </div>
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                                ...
		                                <input type="text" name="address2" id="inputAddress2" class="form-control" placeholder="{$LANG.orderForm.streetAddress2}" value="{$clientsdetails.address2}"{if $loggedin} readonly="readonly"{/if}>
		                            </div>
		                        </div>
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                                ...
		                                <input type="text" name="city" id="inputCity" class="form-control" placeholder="{$LANG.orderForm.city}" value="{$clientsdetails.city}"{if $loggedin} readonly="readonly"{/if}>
		                            </div>
		                        </div>
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                        ...
		                        <div class="col-sm-6 form-group">
		                            <div class="prepend-icon">
		                                ...
		                                <input type="text" name="postcode" id="inputPostcode" class="form-control" placeholder="{$LANG.orderForm.postcode}" value="{$clientsdetails.postcode}"{if $loggedin} readonly="readonly"{/if}>
		                            </div>
		                        </div>
				        ...
				        {if !$loggedin}
					        <div class="tab-section">
				            	<h5 class="tab-title">{$LANG.orderForm.accountSecurity}</h5>
				                ...
				                <div class="row">
				                    <div class="col-sm-6">
				                        <div class="form-group">
				                            ...
				                            <input type="password" name="password" id="inputNewPassword1" class="form-control" placeholder="{$LANG.clientareapassword}">
				                        </div>
				                    </div>
				                    <div class="col-sm-6">
				                        <div class="form-group">
				                            ...
				                            <input type="password" name="password2" id="inputNewPassword2" class="form-control" placeholder="{$LANG.clientareaconfirmpassword}">
				                        </div>
				                    </div>
				                    <div class="col-sm-6">
				                        <div class="progress">
				        ...
				        <div id="creditCardInputFields"{if $selectedgatewaytype neq "CC"} class="hidden"{/if}>
				            ...
				            <div id="newCardInfo" class="row{if $clientsdetails.cclastfour && $ccinfo neq "new"} hidden{/if}">
				                ...
				                <div class="col-sm-6">
				                    <div class="form-group prepend-icon">
				                        <label for="inputCardNumber"  class="control-label">
			                ...
			                <li>
			                	<a style="cursor: pointer">
					                ...
					                <div class="payment-method-selector-content {$gateway.sysname}">
			                                ...
			                                <img src="{$WEB_ROOT}/templates/orderforms/{$carttpl}/img/{$gateway.sysname}.svg" alt="">
			                   </br>
			                            <span class="name">
			                                {$gateway.name}
			                            </span>
	            ...
	            <div class="panel panel-order">
		        	...
		        	<div class="panel-body">
			        	<textarea name="notes" class="form-control" placeholder="{$LANG.ordernotesdescription}">{$orderNotes}</textarea>
		        	</div>
	            </div>
	            {/if}
				...
				{if $accepttos}
                <div class="hide">
                    <input type="checkbox" name="accepttos" id="accepttos" checked>
                </div>
	            {/if}
		...
		<div class="content-sidebar" id="scrollingPanelContainer">
								...
								<div class="item-row">
                                    <div class="item-qty">
                                        ...
                                        <div class="input-group input-group-xs">
		                                    <input type="text" name="qty[{$num}]" value="{$product.qty}" class="form-control" />
		                                </div>
                                        {/if}
                ...
                <div class="total">
                    ...
                    <form method="post" action="{$WEB_ROOT}/cart.php?a=view">
						<div class="input-group">
							{if $promotioncode}
                            <input type="text" name="promocode" id="inputPromotionCode" class="form-control" placeholder="{lang key="orderPromoCodePlaceholder"}" required="required" value="{$promotioncode}" disabled>
            ...
            <div class="checkbox">
                <label>
                    <input type="checkbox" class="fake-acceptos">
